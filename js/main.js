...
const add_id = "swlboamghhgcsjrh"; // app_id  wrknltonr0foslhs
const app_secret = "eTZPWE82QVZhR3FGcS9CUmE5TWdiUT09"; // app_secret  Nlh1c0F6d0ZDU2pDR0J3YVBVbkhudz09
const key = "3dd6b313e85d4b4aadd27fc7a83a4a1e" // key  433f0c48615a48dfaf2f2b2444297e79
function getWeather() {
...
let days = ['4.4', '5.12', '7.7', '8.15', '9.9', '9.18', '12.13'];
for (let day of days) {
    let d = day.split('.');
    if (mon == d[0] && date == d[1]) {
        document.write(
